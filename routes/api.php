...
Route::group([
    ...
    Route::group([
        ...
        Route::post('time_out/{option?}', 'AttendanceController@timeOut');
    ...
    Route::group([
        ...
        Route::get("table", "HierarchyLogController@table");
    ...
    Route::group([
        ...
        Route::get("current", "OvertimeController@current"); // primary table function delete
        // secondary functions
