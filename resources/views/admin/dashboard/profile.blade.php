        ...
        <div class="email-wrapper ">
            ...
            <div class="bdT pX-40 pY-30 col-md-12">
                ...
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    ...
                    @if(isAdminHR())
                    <div class="btn-group">
                        <button type="input" class="btn cur-p btn-primary excel-action-button"  id ="import" data-action="import"><span class="ti-upload"></span></button>
                        <button type="input" class="btn cur-p btn-primary excel-action-button"  id ="export" data-action="export"><span class="ti-download"></span></button>
                    </div>

                    <button type="submit" class="btn cur-p btn-primary form-action-button" id="addflag" data-action="add" data-url="/employee"><span class="ti-pencil-alt"></span></button>
                    @endif
                </div>
                </div>
