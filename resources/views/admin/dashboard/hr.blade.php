...
<div id="hr-dashboard" class="full-container bgc-white">
    <div class="row">
        <div id="hierarchy-profile-preview" class="col-md-3 pX-0 mX-0 bd">
            ...
            <div class="row w-100 pX-15 pT-10 mX-0">
                <div class="col text-right pX-0 mX-0">
                    <span class="ti-close fw-900 fsz-xs" id='hierarchy-profile-close'></span>
                </div>
            </div>
            <div class="row w-100 pX-0 mX-0 ">
                <div class="col pL-30 pT-5 pB-20 mR-0 pR-5 w-100 h-200">
                    ...
                    if(!empty($profile->image)){
                        echo '<div id="profile-image-display" class="profile-image-cover bdrs-50p" style="background-image:url('.$profile->image.');width:150px;height:150px;-webkit-box-shadow: 0 10px 6px -6px #777;-moz-box-shadow: 0 10px 6px -6px #777;box-shadow: 0 10px 6px -6px #777;"></div>';
                    }else{
                        echo '<div id="profile-image-display" class="profile-image-cover bdrs-50p" style="background-image:url(/images/nobody.jpg);width:150px;height:150px;-webkit-box-shadow: 0 10px 6px -6px #777;-moz-box-shadow: 0 10px 6px -6px #777;box-shadow: 0 10px 6px -6px #777;"></div>';
                    }
                @endphp
                </div>
                <div class="col mX-0 pX-0 pL-0 align-self-center">
                    <div class='mX-0 pX-0 w-100'>
                        <div class='fw-500 mL-0 mX-0 pL-0 pR-20 c-blue-500' style="font-size:1em;" id='name_P'>{{$profile->firstname." ".$profile->middlename." ".$profile->lastname}}</div>    
                        <div class='mL-0 c-grey-600' style="font-size:.9em;" id='role_P'>{{ $role->name }}</div>    
                        <div>@if(isAdmin())
                            <span class="ti-pencil-alt form-action-button c-blue-300" id="profile-edit-button" data-portion="profile" data-action="edit" data-id="{{$profile->id}}" style='cursor:pointer'></span>
                            @endif</div>
                    </div>
                </div>
            </div>
                ...
                <div class="row pY-15  bdT bdB">
                    <div class="col-md-12 mX-0 pX-0">
                        ...
                        <div class="col mX-0 pX-0"  style='line-height:30px;'>
                            ...
                            <div class="text-left fsz-xs" id='status_P'>{{$profile->status=='new_hired'?'Newly Hired': ucwords($profile->status)}}</div>
                        </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pY-15  bdT bdB pB-70">
                    <div class="col-md-12 mX-0 pX-0">
                        ...
                        <div class="col mX-0 pX-0"  style='line-height:30px;'>
                            ...
                            <div class="text-left fsz-xs" id='philhealth_P'>{{$profile->benefits[1]->id_number}}</div>
