        ...
        <ul class="lis-n p-0 m-0 fsz-sm w-100">
          <li v-for="item in table[tableName].data.options" v-bind:key="item.id">
            <div class="row pY-10 bdT bdB mT-0 mB-0">
              <div class="col-sm-3">
                <div class="text-left pB-5" style="font-size:0.6em">Type</div>
                <div class="text-center">{{item.type_number}}</div>
              </div>
              <div class="col-sm-5">
                <div class="text-left pB-5" style="font-size:0.6em">Description</div>
                <div class="text-left">{{item.type_description}}</div>
              </div>
              <div class="col-2">
    ...
    <modal name="sanction_type" :pivotY="0.2" :scrollable="true" width="350px" height="auto">
      <div class="layer">
        <div class="e-modal-header bd">
          <h5 style="margin-bottom:0px">Sanction Type</h5>
        </div>
          ...
          <div class="row">
            ...
            <div class="peer text-right pR-20">
              ...
              <button
                ...
                @click="(form[tableName].type!=''&&form[tableName].description!='' ? 
                      store(
                        {
                          type_number: form[tableName].type,
                          type_description: form[tableName].description
                        },
